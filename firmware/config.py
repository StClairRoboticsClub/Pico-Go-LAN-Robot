...
# ============================================================================
# Waveshare Pico-Go v2 Official Pinout (does NOT conflict with motors)

PIN_LCD_SCK = 10   # SPI Clock (GP10)
PIN_LCD_MOSI = 11  # SPI Data Out (GP11)
PIN_LCD_DC = 8     # Data/Command (GP8)
PIN_LCD_RST = 12   # Reset (GP12)
PIN_LCD_CS = 9     # Chip Select (GP9)
PIN_LCD_BL = 13    # Backlight (GP13)
...
ROBOT_COLORS = {
    ...
    2: (255, 255, 0),    # BLITZ - Yellow
    3: (255, 0, 0),      # NITRO - Red
    4: (0, 255, 0),      # TURBO - Green
    5: (255, 255, 255),  # SPEED - White
    6: (0, 0, 255),      # BOLT - Blue
    7: (0, 255, 128),    # FLASH - Teal
    8: (0, 200, 255)     # STORM - Cyan
}
